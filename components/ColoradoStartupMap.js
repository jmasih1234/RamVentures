...
const coloradoStartups = [
  ...
  },
  {
    ...
    lat: 40.5878,
    lng: -105.0849,
    description: 'Rental management software for tenant screening, payments, and listings.',
    stage: 'Growth',
  ...
  },
  {
    ...
    lat: 40.5835,
    lng: -105.0797,
    description: 'Modern bill management and payments platform for banks, fintechs, and billers.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'billgo.com',
  },
  {
    ...
    lat: 40.5799,
    lng: -105.0735,
    description: 'Marketing and CRM platform helping small businesses grow online.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'madwire.com',
  },
  {
    id: 19,
    name: 'Axiota Animal Health',
    industry: 'Ag-Biotech',
    location: 'Fort Collins, CO',
    lat: 40.5892,
    lng: -105.0901,
    description: 'Animal health products for beef and dairy producers.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'axiota.com',
  },
  {
    ...
    lat: 40.5928,
    lng: -105.0833,
    description: 'Electrified boiler technology producing decarbonized steam.',
    stage: 'Seed',
    contact: 'General Contact',
    website: 'atmoszero.energy',
  },
  {
    id: 21,
    name: 'Secure64',
    ...
    lat: 40.5764,
    lng: -105.0863,
    description: 'Carrier-grade DNS and network security software for critical infrastructure.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'secure64.com',
  },
  {
    id: 22,
    name: 'The Food Corridor',
    industry: 'Foodtech',
    location: 'Fort Collins, CO',
    lat: 40.5840,
    lng: -105.0718,
    description: 'Platform for finding, booking, and paying for commercial kitchen space.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'thefoodcorridor.com',
  },
  {
    id: 23,
    name: 'KLOwen Braces',
    ...
    lat: 40.5901,
    lng: -105.0781,
    description: 'Orthodontic technology with prefabricated modular braces systems.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'klowenbraces.com',
  },
  {
    id: 24,
    name: 'Prieto Battery',
    ...
    lat: 40.5818,
    lng: -105.0887,
    description: 'Advanced battery company with origins in CSU\'s energy innovation ecosystem.',
    stage: 'Growth',
    contact: 'General Contact',
    website: 'prietobattery.com',
  },
];
